...
=======
		public static readonly Dictionary<string, string[]> DialogsDict = new Dictionary<string, string[]>() {
			...
			{ "example1", new[] { "Example 1", "Example 1", "第一例" } 
				...
				,  {"Empty_Chest" , new[] { "It looks empty" , "Il semble vide" , "空っぽのように見える"}}
			,  {"Dialog_Foret_Npc_Green" , new[] { "Don't get lost in the dark, only God knows what's in there." , "Ne te perds pas dans l'obscurité, seul Dieu sait ce qu'il y a à l'intérieur." ,"暗闇で迷わないで、そこに何があるかは神のみぞ知る。"}}
			,  {"Dialog_Foret_Npc_Blue" , new[] { "The light of God will guide you out of this darkness, have faith in him." , "La lumière de Dieu vous guidera hors de cette obscurité, ayez foi en lui." ,"神の光があなたをこの暗闇から導いてくれるでしょう。神を信じてください。"}}
			,  {"Dialog_Foret_Npc_Red" , new[] { "Are you already going ?" , "Tu pars déjà ?" ,"もお 行くの?"}}
