...
namespace Global {
	public class TextValues {
		...
		public static readonly Dictionary<string, string[]> DialogsDict = new Dictionary<string, string[]>() {
			...
			, { "lore3", new[] { "Don't you should have a weapon ? Please talk to the blue guy on the store", "Ne serais tu pas mieux avec une arme ? Va parler à la personne au manteau bleu derrière le comptoir.", "ねぇ、武器を持った方が良くないか？店員の青いやつに話してみてください。" } }
